...
function M.lsp_config(client, bufnr)
	...
	-- vim.api.nvim_set_keymap("i", "<leader>,", "<C-x><C-o>", { noremap = true, silent = false })
	-- vim.api.nvim_set_keymap("i", "<C-Space>", "<C-X><C-O>", { noremap = true, silent = false })
	-- vim.api.nvim_set_keymap("v", "<C-Space>", "<C-X><C-O>", { noremap = true, silent = false })
	-- vim.api.nvim_set_keymap("c", "<C-Space>", "<C-X><C-O>", { noremap = true, silent = false })
	-- vim.api.nvim_set_keymap("i", "<C-@>", "<C-Space>", { noremap = true, silent = false })
	-- vim.api.nvim_set_keymap("v", "<C-@>", "<C-Space>", { noremap = true, silent = false })
	-- vim.api.nvim_set_keymap("c", "<C-@>", "<C-Space>", { noremap = true, silent = false })
